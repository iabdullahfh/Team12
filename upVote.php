...
$ip_sql=mysqli_query($conn, "SELECT VoteID from votes WHERE FeedbackId ='$id' and UserID='$user'");
...
mysqli_query($conn,$sql);
    ...
    $sql_vote="INSERT INTO votes (FeedbackId, UserID) values ('$id', '$user')"; 
...
mysqli_query($conn,$sql2);
    $sql_vote2="INSERT INTO votes (FeedbackId, UserID) values ('$id', $user)";
